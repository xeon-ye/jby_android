...
public class MarkChoicePhaseAdapter extends BaseQuickAdapter<TeacherClassCouresResultBean, BaseViewHolder> {

    private List<TeacherClassCouresResultBean> mList = new ArrayList<>();
    ...
    @Override
    protected void convert(final BaseViewHolder helper, final TeacherClassCouresResultBean bean) {
        ...
        helper.setText(R.id.tv_name, bean.getGradeName())
                .addOnClickListener(R.id.tv_name);
    }

    public void addAllData(List<TeacherClassCouresResultBean> dataList) {
        this.mList = dataList;
