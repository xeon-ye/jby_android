...
public class PeriodCourseBean {
    ...
    private HashMap<String, List<ValuesBean.FirstBean>> values;
    private List<TypesBean> types;

    public HashMap<String, List<ValuesBean.FirstBean>> getValues() {
        return values;
    }

    public void setValues(HashMap<String, List<ValuesBean.FirstBean>> values) {
        this.values = values;
    }
    ...
    public static class ValuesBean {
        ...
        private HashMap<String, List<FirstBean>> courses;

        public HashMap<String, List<FirstBean>> getCourses() {
            return courses;
        }

        public void setCourses(HashMap<String, List<FirstBean>> courses) {
