...
//        return FormDataConvertUtil.getRequestBody(hashMap);
     ...
     * @return
     */
    public static RequestBody MultipleAchievementBody(String roleId, String classId, String examId, String keywords) {
        HashMap<String, String> hashMap = new HashMap<>();
        hashMap.put("classId", classId);
     ...
     * @return
     */
    public static RequestBody ClassAchievementBody(String roleId, String classId, String examId, String courseId, String params) {
        HashMap<String, String> hashMap = new HashMap<>();
        hashMap.put("classId", classId);
        hashMap.put("examId", examId);
        hashMap.put("roleId", roleId);
     ...
     * @return
     */
    public static RequestBody SectionAchievementBody(String roleId, String classId, String examId,
                                                     String courseId, String current, String size, String params) {
        HashMap<String, String> hashMap = new HashMap<>();
        hashMap.put("classId", classId);
        hashMap.put("examId", examId);
        hashMap.put("courseId", courseId);
     ...
     * @return
     */
    public static RequestBody StuInfoTableBody(String classId, String examId, String courseId,
                                               String current, String size, String params) {
        HashMap<String, String> hashMap = new HashMap<>();
        hashMap.put("classId", classId);
        hashMap.put("examId", examId);
        hashMap.put("courseId", courseId);
     ...
     * @return
     */
    public static RequestBody getReportFormColumnar(String roleId,String examId, String studId) {
        HashMap<String, String> hashMap = new HashMap<>();
        hashMap.put("examId", examId);
        hashMap.put("studId", studId);
        hashMap.put("roleId", roleId);
