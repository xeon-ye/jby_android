...
public class SeeChoiceAchievementActivity extends AwMvpActivity<SeeAchievementPresent> implements SeeAchievementView.View,
    ...
    protected void initListener() {
        ...
        mBtnConfirm.setOnClickListener(v -> {
            ...
            if (AwDataUtil.isEmpty(mQuestionOptionBeanList)) {
                SeeChoiceAchievementActivity.this.showDialog("选项列表不存在");
                return;
            }
            ...
            if (AwDataUtil.isEmpty(selectQuesetionAnswer)) {
                SeeChoiceAchievementActivity.this.showDialog("您尚未选择需要修改的答案");
                return;
            }
            if (currentStudentAnswer.equals(selectQuesetionAnswer)) {
                SeeChoiceAchievementActivity.this.showDialog("未修改答案，不可执行确认修改操作");
                return;
            }
    ...
    public void getHomeworkScoreStudentAllSuccess(List<AllStudentScoreResultBean> model) {
        ...
        mAchievementList = AchievementDataUtil.convertChoiceData(model);
