...
import com.jkrm.education.ui.activity.login.ChoiceCourseActivity;
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.ll_change_psw:
                ...
                break;
            case  R.id.ll_school:
                //toClass(ChoiceCourseActivity.class,false, Extras.KEY_REGISTER_ID,UserUtil.getAppUser().getId());
                break;
            case R.id.ll_course:
                //toClass(ChoiceCourseActivity.class,false, Extras.KEY_REGISTER_ID,UserUtil.getAppUser().getId());
                break;
