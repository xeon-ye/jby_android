...
public abstract class AwBaseLazyFragment extends LazyFragment implements AwBaseView, View.OnClickListener {
    ...
    protected void setToolbarLeftImgWithRightTxt(String title, int leftId, String rightTxt, AwViewCustomToolbar.OnLeftClickListener leftListener,
                                                 AwViewCustomToolbar.OnRightClickListener rightClickListener) {
        mToolbar = (AwViewCustomToolbar) view.findViewById(R.id.toolbar_custom);
        if(mToolbar != null) {
            if(!AwDataUtil.isEmpty(title)) {
                mToolbar.setToolbarTitle(title);
            ...
            mToolbar.setLeftImgWithSizeValue(leftId);
            mToolbar.setOnLeftClickListener(leftListener);
            mToolbar.showRightView();
            mToolbar.setRightText(rightTxt);
            mToolbar.setOnRightClickListener(rightClickListener);
        }
