...
public class BarChartCommonSingleYHelper {
    ...
    public static void setBarChart(BarChart barChart, List<String> xAxisValue, List<Float> yAxisValue, String title, Integer barColor, int count, int leftDotNum, String leftSuffix, int topNum, String topSuffix) {
        ...
        //设置柱状图数据
        setBarChartData(barChart, yAxisValue, title, barColor, xAxisValue.size());
...
//        barChart.animateX(1500);//数据显示动画，从左往右依次显示
    ...
    private static void setBarChartData(BarChart barChart, List<Float> yAxisValue, String title, Integer barColor, int size) {
