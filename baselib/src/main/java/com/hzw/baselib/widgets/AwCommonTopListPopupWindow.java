 ...
 */
public class AwCommonTopListPopupWindow extends PopupWindow {
    ...
    public AwCommonTopListPopupWindow(final Activity mActivity, OnDismissListener dismissListener) {
        super(mActivity);
