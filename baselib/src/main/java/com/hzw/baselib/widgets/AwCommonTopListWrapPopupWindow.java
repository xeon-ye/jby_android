 ...
 */
public class AwCommonTopListWrapPopupWindow extends PopupWindow {
    private Activity mActivity;
    private OnItemClickListener mOnItemClickListener;
    private CommonTopListAdapter mAdapter;
    ...
    public AwCommonTopListWrapPopupWindow(final Activity mActivity, OnDismissListener dismissListener) {
        super(mActivity);
        this.mActivity = mActivity;
        contentView = View.inflate(mActivity, R.layout.view_popupwindow_common_top_warp_list, null);
        RecyclerView rcv_data = (RecyclerView) contentView.findViewById(R.id.rcv_data);
        mAdapter = new CommonTopListAdapter();
