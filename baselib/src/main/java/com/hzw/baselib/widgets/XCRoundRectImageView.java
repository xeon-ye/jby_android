...
import static com.hzw.baselib.constants.AwBaseConstant.CORNER_COMMON;

/**
 * Created by hzw on 2018/9/3.
 */
...
public class XCRoundRectImageView extends ImageView {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (null != drawable) {
            ...
            Bitmap b = getRoundBitmap(bitmap, AwDisplayUtil.dip2px(mContext, CORNER_COMMON));
