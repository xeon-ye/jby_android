...
/**
 * Created by hzw on 2017/11/10.
 */

public class AwViewPinchImage extends android.support.v7.widget.AppCompatImageView {
    ...
    public boolean canScrollHorizontally(int direction) {
        if (mPinchMode == AwViewPinchImage.PINCH_MODE_SCALE) {
            return true;
        }
    ...
    public interface OuterMatrixChangedListener {
         ...
         */
        void onOuterMatrixChanged(AwViewPinchImage pinchImageView);
    }
    ...
    public AwViewPinchImage(Context context) {
        super(context);
        initView();
    }

    public AwViewPinchImage(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public AwViewPinchImage(Context context, AttributeSet attrs, int defStyle) {
     ...
     * 在onTouchEvent末尾被执行.
     */
    private GestureDetector mGestureDetector = new GestureDetector(AwViewPinchImage.this.getContext(), new GestureDetector.SimpleOnGestureListener() {
        ...
        public void onLongPress(MotionEvent e) {
            ...
            if (mOnLongClickListener != null) {
                mOnLongClickListener.onLongClick(AwViewPinchImage.this);
            }
        }
        ...
        public boolean onSingleTapConfirmed(MotionEvent e) {
            ...
            if (mOnClickListener != null) {
                mOnClickListener.onClick(AwViewPinchImage.this);
            }
            return true;
        }
    });
