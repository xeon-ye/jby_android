...
public class OnlineNonGroupSubjectiveQuestionsChildFragment extends AwMvpFragment<OnlineNonGroupSubjectiveQuestionsChildFragmentPresent> implements OnlineNonGroupSubjectiveQuestionsChildFragmentView.View{
                ...
                if(i==mImgList.size()-1){
                    ...
                    photoFragmentDialog.setOnDialogButtonClickListener(new PhotoFragmentDialog.OnDialogButtonClickListener() {
                        ...
                        public void photoButtonClick() {
                            //拍照并裁剪
                            PictureSelector.create(OnlineNonGroupSubjectiveQuestionsChildFragment.this).openCamera(PictureMimeType.ofImage()).enableCrop(true).freeStyleCropEnabled(true).compress(true).rotateEnabled(true).forResult(1);
                        }

                        @Override
                        public void choseButtonClick() {
                            //拍照并裁剪
                            PictureSelector.create(OnlineNonGroupSubjectiveQuestionsChildFragment.this).openGallery(PictureMimeType.ofImage()).maxSelectNum(1).freeStyleCropEnabled(true).compress(true).rotateEnabled(true).forResult(1);
