 ...
 * @Author: xiangqian
 * @CreateDate: 2020/3/27 10:59
 */

public class CoursePurchasedPresent extends AwCommonPresenter implements CoursePurchasedView.Presenter {
    private CoursePurchasedView.View mView;

    public CoursePurchasedPresent(CoursePurchasedView.View view) {
        mView = view;
    }
