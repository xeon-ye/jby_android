...
public class QuestionBasketActPresent extends AwCommonPresenter implements QuestionBasketView.Presenter {

    private QuestionBasketView.View mView;

    public QuestionBasketActPresent(QuestionBasketView.View view) {
        this.mView = view;
    }
