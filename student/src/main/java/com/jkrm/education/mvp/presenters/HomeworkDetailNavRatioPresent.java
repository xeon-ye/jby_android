...
public class HomeworkDetailNavRatioPresent extends AwCommonPresenter implements HomeworkDetailNavRatioView.Presenter {

    private HomeworkDetailNavRatioView.View mView;

    public HomeworkDetailNavRatioPresent(HomeworkDetailNavRatioView.View view) {
        this.mView = view;
    }
