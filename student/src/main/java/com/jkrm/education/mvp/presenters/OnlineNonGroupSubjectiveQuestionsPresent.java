 ...
 * @Author: xiangqian
 * @CreateDate: 2020/4/29 15:17
 */

public class OnlineNonGroupSubjectiveQuestionsPresent extends AwCommonPresenter implements OnlineNonGroupSubjectiveQuestionsView.Presenter  {
    private OnlineNonGroupSubjectiveQuestionsView.View mView;

    public OnlineNonGroupSubjectiveQuestionsPresent(OnlineNonGroupSubjectiveQuestionsView.View view) {
        this.mView = view;
    }
    @Override
