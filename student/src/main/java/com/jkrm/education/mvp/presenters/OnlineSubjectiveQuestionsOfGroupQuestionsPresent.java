 ...
 * @Author: xiangqian
 * @CreateDate: 2020/4/29 15:34
 */

public class OnlineSubjectiveQuestionsOfGroupQuestionsPresent extends AwCommonPresenter implements OnlineSubjectiveQuestionsOfGroupQuestionsView.Presenter {
    private OnlineSubjectiveQuestionsOfGroupQuestionsView.View mView;

    public OnlineSubjectiveQuestionsOfGroupQuestionsPresent(OnlineSubjectiveQuestionsOfGroupQuestionsView.View view) {
        this.mView = view;
    }
    @Override
