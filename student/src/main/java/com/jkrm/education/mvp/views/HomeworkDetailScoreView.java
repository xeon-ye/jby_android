 ...
 */
public interface HomeworkDetailScoreView extends AwBaseView {

    interface Presenter extends AwBasePresenter {
        void report_question(String homeworkId, String studentId);
    }

    interface View extends AwBaseView {
        void report_questionSuccess(List<ReportQuestionScoreResultBean> result);
        void report_questionFail(String msg);
    }
