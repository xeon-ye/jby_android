 ...
 * @Author: xiangqian
 * @CreateDate: 2020/5/27 10:29
 */

public class OnlineNonGroupSubjectiveQuestionsChildFragmentPresent extends AwCommonPresenter implements OnlineNonGroupSubjectiveQuestionsChildFragmentView.Presenter {

    private OnlineNonGroupSubjectiveQuestionsChildFragmentView.View mView;

    public OnlineNonGroupSubjectiveQuestionsChildFragmentPresent(OnlineNonGroupSubjectiveQuestionsChildFragmentView.View view) {
        this.mView = view;
    }
