...
public class OnlineGroupObjectQuestionPresent extends AwCommonPresenter implements OnlineGroupObjectiveQuestionsView.Presenter  {

    private OnlineGroupObjectiveQuestionsView.View mView;

    public OnlineGroupObjectQuestionPresent(OnlineGroupObjectiveQuestionsView.View view) {
        this.mView = view;
    }
