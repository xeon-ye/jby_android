...
public class BookExercisesAdapter extends BaseQuickAdapter<BookExercisesBean.Value, BaseViewHolder> {

    private List<BookExercisesBean.Value> mList = new ArrayList<>();

    public BookExercisesAdapter() {
        super(R.layout.adapter_mark_choice_common);
    }

    @Override
    protected void convert(final BaseViewHolder helper, final BookExercisesBean.Value bean) {
    ...
    public void addAllData(List<BookExercisesBean.Value> dataList) {
        this.mList = dataList;
