...
public class OnlineAnswerChoiceAdapter extends BaseQuickAdapter<QuestionOptionBean, BaseViewHolder> {
    private List<QuestionOptionBean> mList = new ArrayList<>();

    public OnlineAnswerChoiceAdapter() {
        super(R.layout.onlineanswer_choise_item_layout);
    }
