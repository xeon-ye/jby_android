...
public class ErrorQuesitonDetailAdapter extends BaseQuickAdapter<ErrorQuestionDetailBean, BaseViewHolder> {

    private List<ErrorQuestionDetailBean> mList = new ArrayList<>();
    ...
    public ErrorQuesitonDetailAdapter() {
        super(R.layout.error_question_item_layout);
    }

    @Override
    protected void convert(BaseViewHolder helper, ErrorQuestionDetailBean bean) {
        ...
        checkBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                bean.setChose(b);
                int i=0;
                for (ErrorQuestionDetailBean errorQuestionDetailBean : mList) {
                    if(errorQuestionDetailBean.isChose()){
                        i++;
                    }
                }
                RxLQuestionType rxLQuestionType = new RxLQuestionType("已选择" + i + "题(" + mList.size() + ")", 2);
                ...
                if (null != bean.getOptions()) {
                    ...
                    questionBasketOptionsAdapter.setOnItemChildClickListener(new OnItemChildClickListener() {
                        ...
                        public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
                            ErrorQuestionDetailBean errorQuestionTimeBean = bean;
                            Gson gson = new Gson();
     ...
     * 选择题选项列表数据填充.
     */
    private void setChoiceListData(ErrorQuestionDetailBean bean, QuestionBasketOptionsAdapter adapter, RecyclerView rcvData) {
    ...
    public void addAllData(List<ErrorQuestionDetailBean> dataList) {
        this.mList = dataList;
